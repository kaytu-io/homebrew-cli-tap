class Kaytu < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    def install
      system "tar", "-xf", "#{buildpath}/kaytu_0.3.29_darwin_amd64.tar.gz"
  ...
  if OS.mac? && Hardware::CPU.arm?
    ...
    def install
      system "tar", "-xf", "#{buildpath}/kaytu_0.3.29_darwin_arm64.tar.gz"
  ...
  if OS.linux? && Hardware::CPU.arm?
    ...
    def install
      system "tar", "-xf", "#{buildpath}/kaytu_0.3.29_linux_arm64.tar.gz"
  ...
  if OS.linux? && Hardware::CPU.intel?
    ...
    def install
      system "tar", "-xf", "#{buildpath}/kaytu_0.3.29_linux_amd64.tar.gz"
