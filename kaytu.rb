class Kaytu < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/kaytu-io/cli-program/releases/download/v1.8.28/ktucli-macos-arm64"
  ...
  if OS.linux? && Hardware::CPU.arm?
    url "https://github.com/kaytu-io/cli-program/releases/download/v1.8.28/ktucli-linux-arm64"
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/kaytu-io/cli-program/releases/download/v1.8.28/ktucli-linux-amd64"
